...
class Member extends AdminBase
{
    ...
    public function getMemberInfo($where = [], $field = true)
    {
        ...
        $info['auditor_nickname'] = $this->modelMember->getValue(['id' => $info['auditor_id']], 'nickname');
     ...
     * 获取会员列表
     */
    public function getMemberList($where = [], $field = 'm.*,b.nickname as leader_nickname,c.name as category_name', $order = '', $paginate = DB_LIST_ROWS)
    {
        ...
        $join = [
                    ...
                    [SYS_DB_PREFIX . 'frame c', 'm.frame_id = c.id'],
                ];
     ...
     * @return mixed
     */
    public function get_member_all($where = [], $field = 'm.id,m.nickname', $order = '', $paginate = DB_LIST_ROWS, $join = [])
    {
